...
export function MGCUniform(arrivalRate, min, max, numberOfServers) {
  let serviceRate = 2 / (min + max)
 ...
 while (cp < 0.999999) {
  ...
  for (let i = 0; i < numberOfCustomers; i++) {
    let time = min + (max - min) * Math.random()
...
console.log(MGCUniform(1, 2, 5, 10))
